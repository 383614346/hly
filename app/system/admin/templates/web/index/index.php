...
-->
		...
		<dl>
			<dt>总队专属</dt>
			<dd>
					<a href="{$_M[url][site_admin]}index.php?lang=cn&anyid=44&n=statis&c=statis&a=doindex" title="文章统计" class="on">
						<i class="fa fa-paper-plane"></i>文章统计
					</a>
					<a href="{$_M[url][site_admin]}index.php?lang=cn&anyid=44&n=shenhenews&c=shenhenews&a=doindex" title="文章审核" class="on">
						<i class="fa fa-paper-plane"></i>文章审核
					</a>
					<a href="{$_M[url][site_admin]}index.php?lang=cn&anyid=44&n=dutytable&c=dutytable&a=doindex" title="值班表" class="on">
						<i class="fa fa-paper-plane"></i>值班表
					</a>
					<a href="{$_M[url][site_admin]}index.php?n=system&c=news&a=doindex&lang=cn" title="值班表" class="on">
						<i class="fa fa-paper-plane"></i>局长邮件
					</a>
					<a href="{$_M[url][site_admin]}index.php?lang=cn&anyid=44&n=fenleilink&c=fenleilink&a=doindex" title="分类链接" class="on">
						<i class="fa fa-paper-plane"></i>分类链接
					</a>
			</dd>
		</dl>
