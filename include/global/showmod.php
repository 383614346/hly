...
if ($dbname != $met_download && $dbname != $met_img && $dbname != $met_news && $dbname != $met_product) {
	okinfo('../404.html');
	exit();
}
...
// 		if ($list['class1'] > 1 && $list['class1'] < 6 || $list['class1'] == 7) {
